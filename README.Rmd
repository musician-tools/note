...
The package was initially conceived [by Jim Hester](https://resources.rstudio.com/rstudio-conf-2018/you-can-make-a-package-in-20-minutes-jim-hester){target="_blank"} as an example of how to quickly build an R package. 
...
But this repo is also meant to be an *imursive* companion guide to Jim Hester's, 'You can make an R package in 20 minutes'.
...
- [**usethis**](https://CRAN.R-project.org/package=usethis){target="_blank"}: Automate Package and Project Setup. Hadley Wickham and Jennifer Bryan (2019).
